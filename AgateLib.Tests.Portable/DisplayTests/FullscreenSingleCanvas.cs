...
{
	class FullscreenSingleCanvas : IAgateTest
	{
...
";
    ...
    F6 - {resolutions[5 % resolutions.Count]}";
		...
		public string Name => "Full Screen Single Canvas";
		...
		public void Run(string[] args)
		{
					...
					.BuildForAllScreens())
			{
				...
				while (AgateApp.IsAlive)
				{
					...
					DrawMousePointer(mousePointerSurface);
		...
		private void DrawMousePointer(Surface mousePointerSurface)
		{
