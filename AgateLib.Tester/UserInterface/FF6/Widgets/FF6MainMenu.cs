            ...
            return new FlexBox(new FlexBoxProps
            {
                ...
                Children =
                {
                    ...
                    new Window(new WindowProps
                    {
                        ...
                        Children =
                        {
                            new Button(new MenuItemProps { Text = "Items", OnAccept = RunItemsMenu  }),
                            new Button(new MenuItemProps { Text = "Skills", OnAccept = e => SelectPCThen(e, RunSkillsMenu) }),
                            new Button(new MenuItemProps { Text = "Equip",  OnAccept = e => SelectPCThen(e, RunEquipMenu) }),
                            new Button(new MenuItemProps { Text = "Relic",  OnAccept = e => SelectPCThen(e, RunRelicMenu) }),
                            new Button(new MenuItemProps { Text = "Status", OnAccept = RunStatusMenu }),
                            new Button(new MenuItemProps { Text = "Config", OnAccept = RunConfigMenu }),
                            new Button(new MenuItemProps { Text = "Save",   OnAccept = RunSaveMenu   }),
                        },
                    }),
                },
            });
