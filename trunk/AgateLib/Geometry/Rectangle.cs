...
namespace AgateLib.Geometry
{
    ...
    public struct Rectangle : IXleSerializable
    {
        ...
        public static Rectangle FromPoints(Point startPt, Point endpt)
        {
            return Rectangle.FromLTRB(Math.Min(startPt.X, endpt.X),
                                      Math.Min(startPt.Y, endpt.Y),
                                      Math.Max(startPt.X, endpt.X),
                                      Math.Max(startPt.Y, endpt.Y));
        }
    }
}