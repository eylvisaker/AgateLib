...
{
    public class MDX1_FontSurface_old : FontSurfaceImpl
    {
        ...
        public MDX1_FontSurface_old( )
        {
        }
        public MDX1_FontSurface_old( string fontFamily, float sizeInPoints)
        {
        ...
        {
            mD3DFont = new Direct3D.Font(mDisplay.D3D_Device, mWinFont);
        }
