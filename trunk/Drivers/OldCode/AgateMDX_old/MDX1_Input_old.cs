...
{
    public class MDX1_Input_old : InputImpl
    {
        public static void Register()
        {
            Registrar.RegisterInputDriver(new InputDriverInfo(
                typeof(MDX1_Input_old), InputTypeID.DirectInput, "Managed DirectInput", 100));
        }
            ...
            foreach (DeviceInstance i in Manager.Devices)
            {
                switch (i.DeviceType)
                {
                    ...
                    case DeviceType.Joystick:
                        ...
                        retval.Add(new MDX1_Joystick_old(d));
    ...
    /// </summary>
    public class MDX1_Joystick_old : JoystickImpl
    {
        ...
        public MDX1_Joystick_old(Device d)
        {
            mDevice = d;
            mDevice.Acquire();
