...
namespace ERY.AgateGL.MDXold
{
    ...
    public class MDX1_DisplayWindow_old : DisplayWindowImpl, MDX1_IRenderTarget_old
    {
        Form frm;
        ...
        public MDX1_DisplayWindow_old(string title, int clientWidth, int clientHeight, 
        ...
        public MDX1_DisplayWindow_old(System.Windows.Forms.Control renderTarget)
        {
        ...
        {
            mDisplay.D3D_Device.SetRenderTarget(0, mBackBuffer);
            mDisplay.D3D_Device.BeginScene();
        }
        public override void EndRender(bool waitVSync)
        {
            mDisplay.D3D_Device.EndScene();
