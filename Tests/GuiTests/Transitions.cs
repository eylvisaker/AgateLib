...
{
	class Transitions : AgateGame, IAgateTest 
	{
		...
		Label infoLabel;
		Button hideMouse;
		Button hideLeftPanel;
		Button hideRightPanel;
		...
		private void CreateGui()
		{
			...
			hideLeftPanel = new Button();
			hideLeftPanel.Text = "Toggle Left Panel Visible";
			hideLeftPanel.Click += (x, y) => { leftPanel.Visible = !leftPanel.Visible; };
			bottomPanel.Children.Add(hideLeftPanel);

			hideRightPanel = new Button();
			hideRightPanel.Text = "Toggle Right Panel Visible";
			hideRightPanel.Click += (x, y) => { rightPanel.Visible = !rightPanel.Visible; };
			bottomPanel.Children.Add(hideRightPanel);

			Window wind = new Window("Transitions");
			wind.SuspendLayout();
